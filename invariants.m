//Magma code to find invariants in quintic ring/sextic resolvent.
...
P<f0,f1,f2,f3,f4,f5,u,v> := PolynomialRing(Q,8);
...
//Degree 24 invariant:
H := Discriminant(u^4*T[5,5] - 2*u^3*T[4,5] + u^2*(2*T[3,5] + T[4,4]) - 2*u*T[3,4] + T[3,3],u);
Factorisation(H);
